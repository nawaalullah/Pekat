    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white col-2" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                <a class="list-group-item list-group-item-action p-3 navnaw3" href="tanggapan_admin.php"><i class="fa-solid fa-comments me-3 ms-2"></i>Tanggapan & Riwayat Pengaduan</a>
...
//SELECT a.*, b.* FROM tanggapan a INNER JOIN pengaduan b ON a.id_pengaduan=b.id_pengaduan
  $no = 1;
    ...
    <div class="modal-dialog  modal-dialog-centered">
      ...
      if (isset($_POST['kirim'])) {
        ...
        echo " <script>
                ...
                window.location='tanggapan_admin.php';
                </script>
                ";
      }  
