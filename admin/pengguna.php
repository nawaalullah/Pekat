    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white col-2" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a class="list-group-item list-group-item-action navnaw3 p-3" href="pengguna.php"><i class="fa-solid fa-user me-3 ms-2"></i>Petugas</a>
                <a class="list-group-item list-group-item-action list-group-item-light p-3" href="generate.php"><i class="fa-solid fa-print me-3 ms-2"></i>Generate Laporan</a>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Akun Petugas</h1>
                    ...
                    <tr>
                        ...
                        <td>
                                    <a href="" class="btn btn-danger py-1 px-3" data-bs-toggle="modal"
                                        data-bs-target="#hapus<?= $data['id_petugas'] ?>">Hapus</a>
                                    <!-- Modal hapus-->
                                    <div class="modal fade" id="hapus<?= $data['id_petugas'] ?>" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Hapus Data Petugas
                                                    </h1>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
